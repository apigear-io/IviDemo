...
DECLARE_LOG_CATEGORY_EXTERN(LogIviTunerFavoritesOLinkSource, Log, All);
/// @brief handles OLink network interactions specific to IIviTunerFavoritesInterface
class IviTunerFavoritesOLinkSource : public ApiGear::ObjectLink::IObjectSource
{
public:
	explicit IviTunerFavoritesOLinkSource();
	virtual ~IviTunerFavoritesOLinkSource() = default;
