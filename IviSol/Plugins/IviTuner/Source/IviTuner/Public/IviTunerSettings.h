...
#include "IviTunerSettings.generated.h"

const FString IviTunerLocalBackendIdentifier = "Local";

/**
 * Implements the settings for the IviTuner plugin.
 */
UCLASS(Config = Engine, DefaultConfig)
class IVITUNER_API UIviTunerSettings : public UObject
{
