...
class IIviTunerPreferencesInterface;
...
public:
	...
	static TScriptInterface<IIviTunerPreferencesInterface> createIIviTunerPreferencesInterface(UGameInstance* GameInstance, FSubsystemCollectionBase& Collection);
#else
	...
	static TScriptInterface<IIviTunerPreferencesInterface> createIIviTunerPreferencesInterface(FSubsystemCollectionBase& Collection);
#endif
};
